...
PRIVATE void mkfs(int use_mem)
{
    ...
    // disp_str("WRITE:");
    // disp_int(2 + sb.nr_imap_sects + sb.nr_smap_sects);
    // disp_str("\nnode:");
    // disp_int(0);
    // disp_str(" imode:");
    // disp_int(pi->i_mode);
...
PUBLIC void read_super_block(int dev) //modified by mingxuan 2020-10-30
{
	...
	*/
    ...
    disp_int(1);
    disp_str("\nnr_imap_sects:");
    disp_int(super_block[i].nr_imap_sects);
    disp_str(" nr_smap_sects:");
    disp_int(super_block[i].nr_smap_sects);
    disp_str(" nr_inode_sects:");
    disp_int(super_block[i].nr_inode_sects);
    disp_str(" inode_isize_off:");
    disp_int(super_block[i].inode_isize_off);
    disp_str(" inode_start_off:");
    disp_int(super_block[i].inode_start_off);
    disp_str(" dir_ent_size:");
    disp_int(super_block[i].dir_ent_size);
    disp_str("\n");
}
