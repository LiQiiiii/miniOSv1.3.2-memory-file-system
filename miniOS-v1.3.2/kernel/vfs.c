...
PUBLIC struct vfs vfs_table[NR_FS]; //modified by mingxuan 2020-10-18
...
PUBLIC void init_super_block_table()
{
    ...
    sb++;
    //super_block[5] is orange/mem's superblock
    sb->sb_dev = DEV_MEM;
    sb->fs_type = ORANGE_TYPE;
    sb++;
...
{ // modified by mingxuan 2020-10-30
    ...
    //device_table[4].dev_name="orange";
    //device_table[4].op=&f_op_table[1];
    vfs_table[5].fs_name = "orange1"; //modifed by mingxuan 2020-10-18
    vfs_table[5].op = &f_op_table[1];
    vfs_table[5].sb = &super_block[5];   //added by mingxuan 2020-10-30
    vfs_table[5].s_op = &sb_op_table[0]; //added by mingxuan 2020-10-30
}
