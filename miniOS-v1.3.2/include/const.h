...
#define HeapLinLimitMAX (HeapLinBase + 0x3FC00000)			 //大小：1G-12M
#define MEMFSLinBase (HeapLinLimitMAX + 0x100000)			 //内存文件系统的起始地址	共享内存与堆顶有1M空闲
#define MEMFSLinLimitMAX (MEMFSLinBase + 0x100000)			 //大小：1M
#define StackLinLimitMAX (MEMFSLinLimitMAX + 0x100000)		 //栈的大小： 1G-128M-4K（注意栈的基址和界限方向）
